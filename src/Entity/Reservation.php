 ...
 * Reservation
 *
 * @ORM\Table(name="reservation", indexes={@ORM\Index(name="fk_user_reservation", columns={"fk_user_reservation"}), @ORM\Index(name="fk_room_reservation", columns={"fk_room_reservation"})})
 * @ORM\Entity
 */
class Reservation
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="fk_user_reservation", referencedColumnName="ID_USER")
     * })
     */
